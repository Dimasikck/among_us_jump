...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.run_sound = pygame.mixer.Sound('assets/sounds/running.ogg')
        self.jump_sound = pygame.mixer.Sound('assets/sounds/jumping.ogg')
        self.land_sound = pygame.mixer.Sound('assets/sounds/jumping.ogg')
        self.jetpack_sound = pygame.mixer.Sound('assets/sounds/jetpack.ogg')
    ...
    def move(self):
        ...
        if not self.is_jumping:
            if (keys[pygame.K_UP] or keys[pygame.K_SPACE] or keys[pygame.K_w]) and (current_time - self.last_jump_time >= self.jump_delay):
